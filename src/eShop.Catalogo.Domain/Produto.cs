...
namespace eShop.Catalogo.Domain
{
    public class Produto : Entity, IAggregateRoot
    {
        ...
        public Produto(string nome, string descricao, bool ativo, decimal valor, Guid categoriaId, DateTime dataCadastro, string imagem, decimal altura, decimal largura, decimal profundidade)
        {
